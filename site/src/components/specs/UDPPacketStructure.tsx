      ...
      <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
          <div className="grid grid-cols-4 gap-0 text-center font-mono text-xs border-b border-gray-200 bg-gray-50">
            <div className="col-span-4 p-2 border-b border-gray-200 text-sm font-bold text-gray-500">32 Bits Width</div>
            <div className="p-2 border-r border-gray-200">0-7</div>
            <div className="p-2 border-r border-gray-200">8-15</div>
            <div className="p-2 border-r border-gray-200">16-23</div>
            <div className="p-2">24-31</div>
          </div>
