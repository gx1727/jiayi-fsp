        ...
        <div className="mt-12 space-y-8">
            <div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
                    <div className="grid grid-cols-8 gap-0 text-center font-mono text-xs border-b border-gray-200 bg-gray-50">
                        <div className="col-span-8 p-2 border-b border-gray-200 text-sm font-bold text-gray-500">64 Bits Width</div>
                        ...
                        <div className="p-1 border-r border-gray-200">24-31</div>
                        <div className="p-1 border-r border-gray-200">32-39</div>
                        <div className="p-1 border-r border-gray-200">40-47</div>
                        <div className="p-1 border-r border-gray-200">48-55</div>
                        <div className="p-1">56-63</div>
                    </div>
                    ...
                    <div className="font-mono text-sm">
                        ...
                        <div className="grid grid-cols-4 divide-x divide-gray-200 border-b border-gray-200">
                            <div className="col-span-2 p-4 bg-green-50 text-green-800 text-center">chunk_id (32 bit)</div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200 text-sm">
                                <tr>
                                    ...
                                    <td className="px-4 py-2 text-gray-500">64</td>
                                    <td className="px-4 py-2 text-gray-500">0</td>
                                    <td className="px-4 py-2 text-gray-700">会话唯一标识，与 MQTT Session 一致</td>
                                </tr>
                                <tr>
                                    <td className="px-4 py-2 font-mono text-blue-600">file_id_hash</td>
                                    <td className="px-4 py-2 text-gray-500">64</td>
                                    <td className="px-4 py-2 text-gray-500">8</td>
                                    <td className="px-4 py-2 text-gray-700">文件内容哈希 (防止误写)</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td className="px-4 py-2 text-gray-500">16</td>
                                    <td className="px-4 py-2 text-gray-500">20</td>
